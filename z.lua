...
local hrRankNames = {
    "Trainee", "Junior Operator", "Junior Director", "Senior Director", "Head Director", "Corporate Intern", 
        ...
        for _, rankName in ipairs(hrRankNames) do
            if rankName == rank then
                ...
                local ranksToAutoKick = {
                    "Trainee", "Junior Operator", "Shift Leader", "Corporate Intern", "Junior Corporate", "Senior Corporate", "Head Corporate",
                ...
                for _, autoKickRank in ipairs(ranksToAutoKick) do
                    if autoKickRank == rank then
